data:extend({
  {
    ...
    working_sound =
    {
      sound =
      {
        filename = "__homeworld_redux__/sound/terraformer.ogg",
        volume = 0.7
      },
      apparent_volume = 1.5
    },
    animation =
    {
      filename = "__homeworld_redux__/graphics/entity/seeder/seeder_animation.png",
      priority = "high",
      width = 300,
      height = 300,
      frame_count = 25,
  ...
  data:extend({
    {
      type = "item",
      name = itemName,
      icon = "__homeworld_redux__/graphics/icons/"..itemName..".png",
  ...
  data:extend({
    {
      ...
      icon = "__homeworld_redux__/graphics/icons/terraform-module-"..itemName..".png",
      flags = { "goes-to-quickbar" },
      subgroup = "module",
      stack_size = 10
    },
