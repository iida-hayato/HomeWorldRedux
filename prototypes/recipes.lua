...
data:extend({
  ...
  -- ALCOHOL RECIPES
...

    {
        ...
        energy_required = 5,
        subgroup = "fluid",
        icon = "__homeworld_redux__/graphics/icons/fluid/mashing.png",
        ingredients = {
...

    {
        ...
        energy_required = 2.5,
        subgroup = "fluid",
        icon = "__homeworld_redux__/graphics/icons/fluid/fermenting.png",
        ingredients = {
  ...
  -- BARREL RECIPES
    --[[{
        ...
        order = "b",
        enabled = "false",
        icon = "__homeworld_redux__/graphics/icons/fluid/fill-water-barrel.png",
        ingredients =
        {
