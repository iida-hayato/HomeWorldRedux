...
local HiTech = data.raw.technology["advanced-electronics-2"] --data.raw.technology["alien-technology"]
...
table.insert(HiTech.effects, {type = "unlock-recipe", recipe = "homeworld-portal"})
...
data:extend({
...

	{
		...
		prerequisites = {"terraforming-1", "advanced-electronics-2"},
		unit = {
			count = 125,
