data:extend({
    {
        ...
        picture = {
            filename = "__homeworld_redux__/graphics/entity/fishery.png",
            width = 192,
            height = 230,
            scale = 0.8,
            shift = {0, -0.8}
...

    {
        ...
        animation = {
            filename = "__homeworld_redux__/graphics/entity/sawmill.png",
            priority = "extra-high",
            width = 260,
            height = 240,
            frame_count = 12,
...

	 {
        ...
        picture = {
            filename = "__homeworld_redux__/graphics/entity/portal/portal.png",
            priority = "low",
            width = 226,
            height = 163,
            shift = {0.9375, 0.0625}
...

	 {
        ...
        {
            {
                filename = "__homeworld_redux__/sound/portal.ogg",
                volume = 1
            }
        },
        created_effect =
...

	 {
        ...
        animations =
        {{
            filename = "__homeworld_redux__/graphics/entity/portal/portal-animation.png",
            priority = "high",
            width = 95,
            height = 215,
            frame_count = 50,
    ...
    animation =
    {
      north =
      {
        filename = "__homeworld_redux__/graphics/entity/distillery/distillery.png",
        width = 156,
        height = 141,
        frame_count = 1,
        shift = {0.5, -0.078125}
    ...
    {
      {
        ...
        animation =
        {
          filename = "__homeworld_redux__/graphics/entity/distillery/boiling-green-patch.png",
          frame_count = 35,
          width = 17,
          height = 12,
      ...
      },
      {
        ...
        north_animation =
        {
          filename = "__homeworld_redux__/graphics/entity/distillery/boiling-window-green-patch.png",
          frame_count = 1,
          width = 21,
          height = 10
        },
  ...
  data:extend({
    {
      ...
      picture = {
          filename = "__homeworld_redux__/graphics/entity/" .. image,
          priority = "low",
          width = 450,
          height = 450,
          shift = {0, 0}
    ...
    },
    {
      type = "item",
      name = name,
      icon = "__homeworld_redux__/graphics/icons/farm.png",
